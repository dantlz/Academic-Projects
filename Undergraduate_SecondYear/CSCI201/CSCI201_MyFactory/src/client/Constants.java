...
public class Constants {
	...
	//TODO public static final double closeEnough = 0.05; //used to see when a worker has gotten close enough to a node
	public static final double closeEnough = 1000;
}
