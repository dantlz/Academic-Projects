...
/*FactoryManager – Receives Factories from the FactoryClientListener. The FactoryManager runs
the simulation of the factory with respect to time. The Manager can have a render panel, but
does not require it in order to run. The simulation is started and stopped by the factoryManager*/
